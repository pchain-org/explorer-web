            ...
            <tbody>
              <tr v-for="item in data.account_list" :key="item.order_no" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  ...
                  <a :href="'/address/' + item.account_address" :title="item.account_address" class="inline-block align-middle truncate font-medium text-blue-600 dark:text-blue-500 hover:underline">{{ item.account_address | ellipsisAddress }}</a>
                </td>
