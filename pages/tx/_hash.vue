  ...
  <div class="relative min-h-screen bg-gray-100 pb-6">
    ...
    <div class="container mx-auto px-4">
      <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div v-if="resCode === 10055" id="myTabContent" class="text-center p-10 text-gray-500">
          <div id="overview" class="p-4 rounded-lg break-words" role="tabpanel" aria-labelledby="overview-tab"></div>
          <div id="logs" class="hidden p-4 rounded-lg" role="tabpanel" aria-labelledby="logs-tab"></div>
          ...
          <p class="mt-5">Sorry, We are unable to locate this TxnHash</p>
        </div>
