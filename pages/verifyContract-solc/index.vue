    ...
    <div class="container mx-auto px-4 py-5">
      ...
      <div class="text-center mb-4">
        <div class="w-md-75 w-lg-75 mx-md-auto">
          ...
          <span class="text-center mt-2 text-sm inline-block rounded-2xl bg-blue-500 text-white px-3 py-1">Compiler Type: SINGLE FILE / CONCATENANTED METHOD</span>
        </div>
      </div>
        ...
        <div id="myTabContent">
          <div id="transactions" class="hidden p-4 rounded-lg" role="tabpanel" aria-labelledby="transactions-tab">
            ...
            <form action="https://api-piscan.plian.org/blockBrowser/contract/uploadContractFile" method="post" class="block mt-3 p-6 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
              <h5 class="mb-2 text-lg font-bold tracking-tight text-gray-900 dark:text-white">Enter the Solidity Contract Code below *</h5>
              <!-- <div class="mb-2">
              ...
              <textarea id="contractCode_input" v-model="contractCode" rows="10" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Please Enter..."></textarea>
            </form>
  ...
  methods: {
    createSolFile() {
      ...
      if (this.contractCode === '') {
        this.$message.error('Please enter contract code')
        document.querySelector('#contractCode_input').focus()
        return
      }
      const data = this.contractCode
      const blob = new Blob([data], { type: 'text/sol' })
      return blob
    },
    initModal() {
    ...
    handleVerify() {
      const file = this.createSolFile(this.contractCode)
