          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              <tr v-for="item in data.token_trade_list" :key="item.block_no" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                  <div class="w-36">
                    <a :href="'/token/' + item.token_symbol" :title="item.token_symbol" class="inline-block w-36 truncate font-medium text-blue-600 dark:text-blue-500 hover:underline">{{ item.token_id | hexToNumber }}</a>
                  </div>
                </td>
                <td class="px-6 py-4">
