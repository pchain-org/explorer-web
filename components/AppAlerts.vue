<template>
  <div class="fixed top-0 w-full z-50">
    ...
    <!-- error -->
    <div id="alert-2"
      class="flex p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 text-center" role="alert">
      ...
      <span class="sr-only">Info</span>
      <div class="ml-3 text-sm font-medium">
        A simple info alert with an <a href="#" class="font-semibold underline hover:no-underline">example link</a>. Give
    ...
    <!-- <div id="alert-5" class="flex p-4 rounded-lg bg-gray-50 dark:bg-gray-800" role="alert">
      <svg aria-hidden="true" class="flex-shrink-0 w-5 h-5 text-gray-800 dark:text-gray-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
      </svg>
      <span class="sr-only">Info</span>
...
export default {
  ...
  methods: {
    initAlerts() {
      ...
      this.errorAlert = new Dismiss($targetEl, null, options)
    },
  },
}
</script>