    ...
    <div class="mx-auto w-full container p-4 sm:p-6">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <div>
          ...
          <a href="javascript:;" class="inline-flex mt-4 items-center px-3 py-2 text-sm text-gray-900 rounded-lg bg-gray-100 hover:bg-gray-200 group dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white" @click="addNetwork">
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400 inline-block mt-4 sm:mt-0">© 2023 <a href="javascript:;" class="hover:underline">Plian™</a>. All Rights Reserved.
        </span>
