<template>
  <div class="flex">
    ...
    <div class="relative w-full">
      <input id="searchDropdown" v-model.trim="queryForm.key" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg md:border-l-gray-50 md:border-l-1 rounded-l-lg md:rounded-l-none border focus:outline-0 border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" :placeholder="inputPlaceholder" @keyup.enter="handleSearch" @input="inputSearch">
